...
#path to your rawFH file ( output of the ARCGIS preprocessing tool)
  rawFH 				= "/mnt/TbSSD/FAMEStatewideReporting2020/ARCGIS_PRO_RAW_FH/FFRAU_FH2020_FAME_vg94_STATEWIDE_SEASON_AS_NUMERIC_NO_1755.shp"
...
print(paste("Using",Ncores,"cores"))
  ...
  ResultsDir<-file.path("./ResultsFFRAU_FH2020_FAME_vg94_STATEWIDE_NO_1755_75m")
