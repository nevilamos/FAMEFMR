...
#' remove empty directories from path Function removes all empty directories
#' from the nominated path
...
#' Joins one or more lookup tables to table containing ID values
#' Function joins Lookup tables (LUTS) to dataframe containing ID_NO: Name combinations
#'
#' @param myDF dataframe or similar containing indices for the LUTS listed, to which the LUTS will be left_joined
#' @param LUTS vector of names of LUTS in memory defaults =c("TFI_LUT","FIREFMZ_LUT","REG_LUT","DELWP_LUT")
...
#' @param RasterMetres numeric Value cell resolution in Metres (usually from RasterRes in settings file).
